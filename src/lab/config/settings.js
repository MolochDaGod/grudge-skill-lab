 ...
 */
export const CAST_ANIMATIONS = ['cast1', 'cast2', 'cast3', 'combo1', 'combo2', 'combo3'];
...
export const settings = {
  ...
  /**
   * Combat locomotion + slash authoring.
   *
   * Dash is a stamina-paid `castStep`. T0 sword 1/2/3 are Practice Slash,
   * Quick Thrust, Wide Sweep — not three copies of the same projectile.
   */
  combat: {
    dashCost: 18,
    dashMeters: 3.4,
  ...
  /** Live aura variant ids (K / M / B). Palettes live in `rpg/auras.js`. */
  aura: {
    fire: 'red',
    magic: 'purple',
    boost: 'electric'
  ...
  /* ================================================================== */
  /* WEAPON · CINDER SLASH — line residual from the blade                */
  /* ================================================================== */
  cinderSlash: {
    range: 11,
    minRange: 1.1,
  ...
  /* ================================================================== */
  /* WEAPON · STAFF FIRE BOLT — linear projectile                        */
  /* ================================================================== */
  fireBolt: {
    range: 18,
    minRange: 1.4,
  ...
  /* T0 sword 1 — Practice Slash (`t0_sword_practice_slash`) */
  combo1: {
    range: 3.4,
    minRange: 0.2,
    speed: 28,
  ...
  /* T0 sword 2 — Quick Thrust (`t0_sword_quick_thrust`) */
  combo2: {
    range: 4.4,
    minRange: 0.2,
    speed: 52,
  ...
  /* T0 sword 3 — Wide Sweep (`t0_sword_wide_sweep`) */
  combo3: {
    range: 2.8,
    minRange: 0,
    speed: 11,
  ...
  /* Two black bodies step out of you and hunt. variant: void | cinder | echo */
  shadowClone: {
    range: 9,
    minRange: 1,
    speed: 14,
  ...
  /* Seal over the mark, fist falls through a portal. fistCount 1–3. */
  skyFist: {
    range: 12,
    minRange: 2,
    speed: 11,
  ...
  /* Rise 3 m and loose a ring of blades. variant: steel | cinder | shadow */
  skyBlades: {
    range: 11,
    minRange: 2,
    speed: 10,
  ...
  /* Hide, fire-body blink, portal above/behind, dive. */
  shadowStep: {
    range: 10,
    minRange: 2.5,
    speed: 16,
  ...
  /* ================================================================== */
  /* ICE — Frost Lance (linear, original LinearAbilityCasting)         */
  /* ================================================================== */
  ice: {
    /* --- the cast itself --- */
...
export const ELEMENT_META = {
  ...
  healBolt: {
    ...
    accent: '#9af0b0',
    key: 'H',
    hint: 'Misty heal dart · green wind',
    cast: CastShape.LINE
  },
  mageTotem: {
    label: 'Nordin Totem',
    accent: '#3adf62',
    key: 'F',
    hint: 'F — plant fire totem, Arcane Bolt secondary',
    cast: CastShape.ZONE
  },
  priestTotem: {
    label: 'Freya Totem',
    accent: '#ffe27a',
    key: 'F',
    hint: 'F — plant heal totem, Smite / Atonement',
    cast: CastShape.ZONE
  },
  virtuosoTotem: {
    label: 'Air Totem',
    accent: '#3fd8ff',
    key: 'F',
    hint: 'F — plant air totem, wind pulse when you act',
    cast: CastShape.ZONE
  },
  ice: {
    label: 'Frost Lance',
  ...
  combo1: {
    label: 'Practice Slash',
    accent: '#fd5700',
    key: '1',
    hint: 'T0 slash — leaves the blade',
    cast: CastShape.LINE
  },
  combo2: {
    label: 'Quick Thrust',
  ...
  shadowClone: {
    ...
    accent: '#8a90a8',
    key: '7',
    hint: 'Two black bodies hunt nearby marks',
    cast: CastShape.ZONE
  },
  skyFist: {
    label: 'Sky Fist',
    accent: '#ffb02e',
    key: '8',
    hint: 'Portal above the mark, fist falls through',
    cast: CastShape.ZONE
  },
  skyBlades: {
    label: 'Sky Blades',
    accent: '#d8dce4',
    key: '9',
    hint: 'Rise 3 m, loose a ring of swords',
    cast: CastShape.ZONE
  },
  shadowStep: {
    label: 'Shadow Step',
    accent: '#ff6a18',
    key: '0',
    hint: 'Blink in fire, portal dive onto the mark',
    cast: CastShape.LINE
  },
  aimedShot: {
    label: 'Aimed Shot',
    accent: '#8adf4a',
    key: '2',
    hint: 'Hold to charge, release a beam',
    cast: CastShape.LINE
  },
  volley: {
    label: 'Volley',
